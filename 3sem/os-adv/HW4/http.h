...
static char *http_messages[] = {[ESOCKNOCREATE] "Socket isn't created",
                                [ESOCKNOCONNECT] "Socket isn't connected",
                                [ESOCKNOMSGSEND] "No message end found",
                                [ESOCKNOMSGRECV] "No message received",
                                [EHTTPBADCODE] "Server error",
                                [EHTTPMALFORMED] "HTTP malformed",
                                [EPROTMALFORMED] "Prot malformed"};
